...
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules vWHERE v.NUMVEHICULE = 1)(SELECT REF(i)FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 1));
