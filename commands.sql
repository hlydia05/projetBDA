...
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 54);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 55);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 56);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 57);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 58);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 59);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 60);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 61);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 62);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 63);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 64);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 65);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 66);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 67);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 68);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 69);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 70);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 71);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 72);
INSERT INTO TABLE(SELECT e.EMPLOYE_INTERVENTIONS FROM Employes e WHERE e.NUMEMPLOYE = 53) SELECT REF(i) FROM Interventions i INNER JOIN Intervenants itr ON itr.NUMINTERVENTION = REF(i) WHERE itr.NUMEMPLOYE = (SELECT REF(e) FROM Employes e WHERE e.NUMEMPLOYE = 80);
