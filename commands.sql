...
--tables vehicules
INSERT INTO Vehicules VALUES(1,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 2),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 6),'0012519216',1992,tset_interventions());
INSERT INTO Vehicules VALUES(2,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 9),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 20),0124219316,1993,tset_interventions());
INSERT INTO Vehicules VALUES(3,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 17),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 8),1452318716,1987,tset_interventions());
INSERT INTO Vehicules VALUES(4,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 6),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 12),3145219816,1998,tset_interventions());
INSERT INTO Vehicules VALUES(5,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 16),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 23),1278919816,1998,tset_interventions());
INSERT INTO Vehicules VALUES(6,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 20),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 6),3853319735,1997,tset_interventions());
INSERT INTO Vehicules VALUES(7,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 7),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 8),1453119816,1998,tset_interventions());
INSERT INTO Vehicules VALUES(8,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 16),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 14),8365318601,1986,tset_interventions());
INSERT INTO Vehicules VALUES(9,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 13),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 15),3087319233,1992,tset_interventions());
INSERT INTO Vehicules VALUES(10,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 20),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 22),9413119935,1999,tset_interventions());
INSERT INTO Vehicules VALUES(11,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 9),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 16),1572319801,1998,tset_interventions());
INSERT INTO Vehicules VALUES(12,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 14),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 20),6025319733,1997,tset_interventions());
INSERT INTO Vehicules VALUES(13,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 19),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 17),5205319736,1997,tset_interventions());
INSERT INTO Vehicules VALUES(14,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 22),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 21),7543119207,1992,tset_interventions());
INSERT INTO Vehicules VALUES(15,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 4),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 19),6254319916,1999,tset_interventions());
INSERT INTO Vehicules VALUES(16,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 16),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 21),9831419701,1997,tset_interventions());
INSERT INTO Vehicules VALUES(17,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 12),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 11),4563117607,1976,tset_interventions());
INSERT INTO Vehicules VALUES(18,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 1),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 2),7973318216,1982,tset_interventions());
INSERT INTO Vehicules VALUES(19,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 18),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 77),3904318515,1985,tset_interventions());
INSERT INTO Vehicules VALUES(20,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 22),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 2),1234319707,1997,tset_interventions());
INSERT INTO Vehicules VALUES(21,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 3),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 19),8429318516,1985,tset_interventions());
INSERT INTO Vehicules VALUES(22,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 8),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 19),1245619816,1998,tset_interventions());
INSERT INTO Vehicules VALUES(23,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 7),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 25),1678918516,1985,tset_interventions());
INSERT INTO Vehicules VALUES(24,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 80),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 9),1789519816,1998,tset_interventions());
INSERT INTO Vehicules VALUES(25,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 13),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 5),1278919833,1998,tset_interventions());
INSERT INTO Vehicules VALUES(26,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 3),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 10),1458919316,1993,tset_interventions());
INSERT INTO Vehicules VALUES(27,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 10),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 7),1256019804,1998,tset_interventions());
INSERT INTO Vehicules VALUES(28,(SELECT REF(c) FROM Tclient c WHERE c.NUMCLIENT = 10),(SELECT REF(m) FROM Tmodele m WHERE m.NUMMODELE = 3),1986219904,1999,tset_interventions());
