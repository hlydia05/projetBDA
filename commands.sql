...
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 ...
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 2);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 3)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 3);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 4)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 4);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 5)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 5);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 6)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 6);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 7)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 7);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 8)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 8);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 9)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 9);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 10)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 10);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 11)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 11);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 12)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 12);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 13)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 13);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 14)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 14);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 15)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 15);

INSERT INTO TABLE (SELECT i.INTERVENTION_INTERVENANTS
                   FROM Interventions i
                   WHERE i.NUMINTERVENTION = 16)
(SELECT Tintervenants(i.NUMINTERVENTION, j.NUMEMPLOYE, j.DATEDEBUT, j.DATEFIN, j.INTERVENANT_EMPLOYES, i.INTERVENTION_INTERVENANTS)
 FROM Employes e, TABLE(e.EMPLOYE_INTERVENANTS) j, Interventions i
 WHERE j.NUMINTERVENTION = i.NUMINTERVENTION
   AND i.NUMINTERVENTION = 16);
