...
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 1) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 1));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 2) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 2));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 3) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 3));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 4) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 4));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 5) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 5));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 6) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 6));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 7) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 7));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 8) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 8));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 9) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 9));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 10) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 10));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 11) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 11));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 12) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 12));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 13) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 13));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 14) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 14));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 15) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 15));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 16) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 16));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 17) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 17));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 18) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 18));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 19) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 19));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 20) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 20));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 21) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 21));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 22) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 22));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 23) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 23));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 24) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 24));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 25) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 25));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 26) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 26));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 27) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 27));
INSERT INTO TABLE (SELECT v.VEHICULE_INTERVENTIONSFROM Vehicules v WHERE v.NUMVEHICULE = 28) (SELECT REF(i) FROM Interventions i WHERE i.NUMVEHICULE = (SELECT REF(v) FROM Vehicules v WHERE v.NUMVEHICULE = 28));
